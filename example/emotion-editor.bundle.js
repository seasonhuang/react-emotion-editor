...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  handleChooseEmotion: function handleChooseEmotion(evt) {
	    var target = evt.target;
	    var img = '<img src="' + target.src + '" data-is="emotion" />';
	  ...
	  handleCtrlEnter: function handleCtrlEnter(evt) {
	  ...
	  renderRecords: function renderRecords() {
	    return this.state.records.map(function (record, index) {
	      return React.createElement(
	        'li',
	        { key: index },
	        React.createElement('pre', { className: 'item', dangerouslySetInnerHTML: { __html: record } })
	      );
	    });
	  },
	  renderEmotion: function renderEmotion() {
	    ...
	    var emotion = [];
	    while (i < 100) {
	      emotion.push(React.createElement('img', {
	        key: i,
